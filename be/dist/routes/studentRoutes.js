...
const baseStudentSchema = z.object({
    ...
    primaryInterest: z.enum(AVAILABLE_MAJORS)
});
...
router.post('/:id/registrations', async (req, res) => {
    ...
    try {
        const registration = await registerStudentForSemesterCourse(studentId, parseResult.data.semester, parseResult.data.courseCode);
