...
import { createAssignment, updateAssignment, deleteAssignment, listStudentAssignments, listTeacherAssignments } from '../services/assignmentService.js';
const router = Router();
...
router.get('/teacher/:teacherId', requireStaff(['TEACHER', 'IT_ADMIN', 'STUDENT_ADMIN']), async (req, res) => {
...
router.post('/', requireStaff(['TEACHER', 'IT_ADMIN', 'STUDENT_ADMIN']), async (req, res) => {
...
router.put('/:id', requireStaff(['TEACHER', 'IT_ADMIN', 'STUDENT_ADMIN']), async (req, res) => {
