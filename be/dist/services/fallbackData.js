export const fallbackFeatures = [
    {
        ...
        description: 'Secure sign-in with admin-issued accounts, centralized profile management, and multi-factor authentication to protect every student account.',
        category: 'Foundation',
        icon: 'shield'
    },
    {
...
export const fallbackTimetables = [
    {
        id: 1,
        studentId: 1,
        weekday: 'Monday',
...
export const fallbackRegistrations = [
    {
        id: 1,
        studentId: 1,
...
export const fallbackClassrooms = [
    {
        id: 1,
...
export const fallbackClassroomEnrollments = [
    {
        id: 1,
        studentId: 1,
        classroomId: 1,
...
export const fallbackFeePayments = [
    {
        id: 1,
        studentId: 1,
        amount: 1200,
...
export const fallbackExamAnnouncements = [
    {
        id: 1,
        title: 'Fall 2024 Midterm Week',
        description: 'Midterm examinations for all core courses will take place between October 14-18. Detailed schedules will be shared in course portals.',
...
export const fallbackSemesterGpa = [
    {
        id: 1,
        studentId: 1,
        semester: 'Fall 2023',
...
export const fallbackTeachingAssignments = [
    {
        id: 1,
        teacherId: 2,
        classroomId: 1,
...
export const fallbackTeacherRosters = [
    {
        id: 1,
        teacherId: 2,
        courseCode: 'BIOE-521',
...
export const fallbackTeacherFocusTags = {
